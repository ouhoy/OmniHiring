...
defineProps<{ firstname: string,lastname:string, email: string, status: string, applicationDate: string }>()
...
<template>
  ...
  <div class="applicant-card-container">
    ...
    <div class="application-buttons">
      <button @click="handleResume" class="primary-btn">Download Resume</button>
